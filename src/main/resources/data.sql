...
VALUES    (1, TRUE, TRUE, TRUE, FALSE, 'PRINCIPAL'),
          (2, TRUE, TRUE, FALSE, TRUE, 'SECONDARY'),
          (3, FALSE, FALSE, TRUE, FALSE, 'PRINCIPAL'),
          (4, TRUE, FALSE, TRUE, TRUE, 'LOCAL');
...
INSERT INTO unit_features (id, private_area, total_area, private_terrace_area, bedrooms, living_rooms, social_bathrooms, private_bathrooms, washroom, closet, office, balcony, storage, is_service_area_separate, garage, unit_items, conservation)
VALUES    (1, 75.50, 100.75, 20.00, 3, 1, 2, 1, 1, 1, 0, 1, 1, TRUE, 2, 12, 9.0),
          (2, 90.00, 120.50, 25.00, 4, 2, 2, 2, 1,  2, 1, 0, 0, FALSE, 1, 15, 8.5),
          (3, 65.00, 80.00, 15.00, 2, 1, 1, 1, 0,  1, 0, 1, 0, TRUE, 1, 10, 7.8),
          (4, 110.00, 150.00, 30.00, 5, 2, 3, 3, 1,  3, 1, 1, 1, TRUE, 3, 20, 9.5);
